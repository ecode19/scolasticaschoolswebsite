    ...
    <section class="w-full flex">
        <div class="w-2/12 h-full fixed left-0 bg-green-100 overflow-y-auto shadow-md shadow-green-700 text-green-950">
            ...
            <div class="w-full p-2 my-4">
                <ul class="w-full">
                    <a href="{{route('admin.dashboard')}}" class="w-full flex items-center text-lg font-semibold hover:bg-green-300 rounded-sm"><i class="fa fa-house mx-1 p-2 my-2"></i><li>Dashboard</li></a>
                    <a href="{{route('admin.blog.index')}}" class="w-full flex items-center text-lg font-semibold hover:bg-green-300 rounded-sm"><i class="fa fa-newspaper mx-1 p-2 my-2"></i><li>Blog</li></a>
                </ul>
            </div>
        </div>
