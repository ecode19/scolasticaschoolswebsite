        ...
        <div class="w-full">
            <div class="absolute bottom-5 left-5 lg:bottom-10 lg:left-10 transparent-bg">
                <div class="text-white text-center">
                    <h1 class="oswald text-xl md:text-4xl lg:text-6xl uppercase text-green-200">Welcome to Scolastica Schools</h1>
                </div>
            </div>
        </div>
    </div>
    <section class="w-full md:w-11/12 mx-auto p-4 my-8">
        <p class="font-semibold text-justify md:text-lg my-4 text-gray-800">Dear Esteemed Parents, Students, and the Scolastica
            Community,</p>
        <p class="text-justify md:text-lg text-gray-600">Education is the foundation upon which <b>great legacies are built, minds are ignited, and futures are shaped</b>. At Scolastica Schools, we are not merely educators—we are <b>architects of excellence, sculptors of character, and pioneers of boundless potential</b>. It is with profound honor and unwavering dedication that Scolastica, welcomes you to our institution where aspirations take flight, and every learner is nurtured to <b>lead, innovate, and excel.</b></p>
        <p class="text-justify md:text-lg text-gray-600 my-2">Spanning <b>Kindergarten, Primary, Secondary, and High
        ...
        <div class="text-justify md:text-lg text-gray-600 my-2 flex items-center"><i class="fa fa-check mr-2"></i>
        ...
        <p class="text-justify md:text-lg text-gray-600 my-2">We take immense pride in our team of <b>visionary
        ...
        <p class="text-justify md:text-lg text-gray-600 my-2">As you embark on this journey with us, we invite you to
        ...
        <p class="text-justify md:text-lg text-gray-600 my-4">Welcome to Scolastica Schools—Where Brilliance Begins, and
            Greatness is Forged.
        </p>
