        ...
        <div class="w-full">
            <div class="absolute bottom-5 left-5 lg:bottom-10 lg:left-10 transparent-bg">
                <div class="text-white text-center">
                    <h1 class="oswald text-xl md:text-4xl lg:text-6xl uppercase text-green-200">Teaching Methods</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="w-full md:w-1/3 my-2">
                    <div class="w-11/12 mx-auto border-2 border-orange-400">
                        ...
                        <div class="my-2 p-2">
                            ...
                            <p class="defaultText md:text-lg text-center">{{$method->description}}</p>
                        </div>
                    </div>
                </div>
            @endforeach
