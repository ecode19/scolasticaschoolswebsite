...
@section('content')
        ...
        <div class="w-full">
            <div class="absolute bottom-10 left-10 transparent-bg">
                <div class="text-white text-center">
                    <h1 class="oswald text-3xl md:text-6xl uppercase text-green-200">Clubs and Extracurricular Activities
                    </h1>
                </div>
            </div>
        </div>
    ...
    <section class="w-11/12 mx-auto my-4 p-4">
        <div class="w-full my-4">
            <p class="defaultText text-justify text-lg">At Scolastica Secondary School, we believe that learning goes beyond
    ...
    <section class="w-full mx-auto p-2 flex flex-col md:flex-row my-8">
        ...
        <div class="w-full md:w-1/2 p-2 md:p-4 lg:p-8 order-2 md:order-2">
            ...
            <p class="defaultText text-justify text-lg text-gray-800 my-4">Extracurricular activities play a vital role in
                ...
                @if ($club->category === 'Academic & Leadership')
                    <div class="w-full md:w-1/3 my-2">
                        <div class="w-11/12 mx-auto">
                            ...
                            <div class="my-2">
                                <h5 class="text-green-800 text-center text-3xl my-2">{{ $club->name }}</h5>
                                <p class="defaultText text-lg text-center">{{ $club->description }}</p>
                            </div>
                        </div>
                    </div>
                @endif
    ...
    <section class="w-full mx-auto p-2 flex flex-col md:flex-row my-8 bg-orange-50">
        ...
        <div class="w-full md:w-1/2 p-2 md:p-4 lg:p-8 order-1 md:order-1">
            ...
            <p class="defaultText text-justify text-lg text-gray-800 my-4">These activities promote physical fitness, teamwork, and discipline. Whether through team sports like football and basketball or individual pursuits like athletics and swimming, students build resilience, healthy habits, and a strong sense of sportsmanship while competing and having fun.</p>
        </div>
    </section>
    ...
    <section class="w-full mx-auto p-2 flex flex-col md:flex-row my-8">
        ...
        <div class="w-full md:w-1/2 p-2 md:p-4 lg:p-8 order-1 md:order-2">
            ...
            <p class="defaultText text-justify text-lg text-gray-800 my-4">Focused on civic engagement and shared passions, these clubs connect students with causes and communitiea that matter to them. They may include environmental clubs, charity groups, or technology and innovation hubs, encouraging responsibility, volunteerism, and broader worldviews.</p>
        </div>
    </section>
