...
@section('content')
    ...
    <section class="w-full p-4">
        <form action="{{ route('admin.clubs.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <h2 class="text-2xl text-center text-green-800 my-4">Create a new Club</h2>
            ...
            <div class="w-full flex flex-col md:p-4">
                ...
                <select name="category"
                    ...
                    <option value="Community & Special Interest">Community & Special Interest</option>
                </select>
                @error('category')
                    <p class="text-lg text-red-600 my-2">{{ $message }}</p>
                @enderror
            ...
            <div class="w-fit mx-auto my-4">
                <button class="py-1 px-2 text-lg bg-green-700 hover:bg-gray-700 text-white rounded-md"><i
                        class="fa fa-rocket mx-2"></i>Add Club</button>
            </div>
        </form>
