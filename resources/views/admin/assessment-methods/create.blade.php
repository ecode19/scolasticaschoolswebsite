...
@section('content')
    ...
    <section class="w-full p-4">
        <form action="{{ route('admin.assessment-method.store') }}" method="POST" enctype="multipart/form-data"
            class="w-full md:w-10/12 mx-auto p-2 bg-green-100">
            @csrf

            <h2 class="text-2xl text-center text-green-800 my-4">Create a new Assessment Method</h2>

            <div class="w-full flex flex-col md:p-4">
                <label for="name" class="w-full text-lg font-semibold text-gray-600">Assessment Method Name:</label>
            ...
            <div class="w-fit mx-auto my-4">
                <button class="py-1 px-2 text-lg bg-green-700 hover:bg-gray-700 text-white rounded-md"><i
                        class="fa fa-rocket mx-2"></i>Add Method</button>
            </div>
        </form>
